...
"""
n=5200--p=750--varying group size dense groups--dg_t
"""
...
data_param = dict(n=5200, p=750, ro=0.5, stn=3, group_sizes_general=[5, 15, 30], num_groups_general=[15, 15, 15], num_non_zero_coef=[5, 15, 30], num_non_zero_groups=[2, 2, 1])
