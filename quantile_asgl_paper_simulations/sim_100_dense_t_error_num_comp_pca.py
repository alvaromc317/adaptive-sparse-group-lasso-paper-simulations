...
"""
n=5200--p=100--dense groups--dg_t--num comp influence--pca
"""
...
data_param = dict(n=6000, num_groups=10, group_size=10, p=100, ro=0.5, num_non_zero_coef_per_group=10, num_non_zero_groups=3)
