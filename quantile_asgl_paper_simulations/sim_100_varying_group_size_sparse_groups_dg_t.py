...
"""
n=5400--p=100--varying group size sparse groups--dg_t
"""
...
alpha = (np.r_[np.arange(0.0, 0.3, 0.02), np.arange(0.3, 0.8, 0.1), np.arange(0.8, 1.0, 0.02), np.array([1])]).tolist()
tau = 0.5
...
data_param = dict(n=5400, p=100, ro=0.5, stn=3, group_sizes_general=[5, 10, 20], num_groups_general=[4, 4, 2], num_non_zero_coef=[2, 5, 10], num_non_zero_groups=[2, 2, 1])
