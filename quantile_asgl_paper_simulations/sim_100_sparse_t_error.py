...
"""
n=5400--p=100--sparse groups--dg_t
"""
...
data_param = dict(n=5400, num_groups=10, group_size=10, p=100, ro=0.5, num_non_zero_coef_per_group=6, num_non_zero_groups=5)
...
sorting = ['lasso', 'sgl', 'asgl_pca_d','asgl_pls_d', 'asgl_unpenalized_qr']
