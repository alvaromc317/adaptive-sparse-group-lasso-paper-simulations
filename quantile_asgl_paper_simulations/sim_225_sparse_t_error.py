...
"""
n=5200--p=225--sparse groups--dg_t
"""
...
data_param = dict(n=5200, num_groups=15, group_size=15, p=225, ro=0.5, num_non_zero_coef_per_group=8, num_non_zero_groups=7)
...
sorting = ['lasso', 'sgl', 'al_asgl_pca_d', 'al_asgl_pca_1', 'al_asgl_pls_d', 'al_asgl_pls_1', 'asgl_pca_d', 'asgl_pca_1', 'asgl_pls_d', 'asgl_pls_1']
