...
"""
n=5400--p=100--varying group size dense groups--dg_t
"""
...
data_param = dict(n=5400, p=100, ro=0.5, stn=3, group_sizes_general=[5, 10, 20], num_groups_general=[4, 4, 2], num_non_zero_coef=[5, 10, 20], num_non_zero_groups=[1, 1, 1])
