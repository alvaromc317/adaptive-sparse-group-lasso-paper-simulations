...
"""
n=5200--p=625--sparse groups--dg_t--num comp influence--pls
"""
...
var_pct = 0.1
asgl_wc_pca_d_1 = dict(l_power_weight=l_power_weight, gl_power_weight=gl_power_weight, var_pct=var_pct, weight_technique='pls_d')

var_pct = 0.2
asgl_wc_pca_d_2 = dict(l_power_weight=l_power_weight, gl_power_weight=gl_power_weight, var_pct=var_pct, weight_technique='pls_d')

var_pct = 0.3
asgl_wc_pca_d_3 = dict(l_power_weight=l_power_weight, gl_power_weight=gl_power_weight, var_pct=var_pct, weight_technique='pls_d')

var_pct = 0.4
asgl_wc_pca_d_4 = dict(l_power_weight=l_power_weight, gl_power_weight=gl_power_weight, var_pct=var_pct, weight_technique='pls_d')

var_pct = 0.5
asgl_wc_pca_d_5 = dict(l_power_weight=l_power_weight, gl_power_weight=gl_power_weight, var_pct=var_pct, weight_technique='pls_d')

var_pct = 0.6
asgl_wc_pca_d_6 = dict(l_power_weight=l_power_weight, gl_power_weight=gl_power_weight, var_pct=var_pct, weight_technique='pls_d')

var_pct = 0.7
asgl_wc_pca_d_7 = dict(l_power_weight=l_power_weight, gl_power_weight=gl_power_weight, var_pct=var_pct, weight_technique='pls_d')

var_pct = 0.8
asgl_wc_pca_d_8 = dict(l_power_weight=l_power_weight, gl_power_weight=gl_power_weight, var_pct=var_pct, weight_technique='pls_d')

var_pct = 0.9
asgl_wc_pca_d_9 = dict(l_power_weight=l_power_weight, gl_power_weight=gl_power_weight, var_pct=var_pct, weight_technique='pls_d')

var_pct = 1
asgl_wc_pca_d_10 = dict(l_power_weight=l_power_weight, gl_power_weight=gl_power_weight, var_pct=var_pct, weight_technique='pls_d')
...
sorting = ['lasso', 'sgl', 'asgl_pls_d_0.1', 'asgl_pls_d_0.2', 'asgl_pls_d_0.3', 'asgl_pls_d_0.4', 'asgl_pls_d_0.5', 'asgl_pls_d_0.6', 'asgl_pls_d_0.7', 'asgl_pls_d_0.8', 'asgl_pls_d_0.9', 'asgl_pls_d_1']
